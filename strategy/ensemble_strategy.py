...
from strategy.sma_cross import SMACrossStrategy  # âœ… FIXED: import
...
class EnsembleStrategy:
    def __init__(self):
        self.strategies = [
            ...
            RSIStrategy(),             # âœ… FIXED: no config
            SMACrossStrategy(),        # âœ… Import added
            BollingerStrategy()        # âœ… no config
        ]
    ...
    def generate_signal(self, data):
        ...
        for strat in self.strategies:
            try:
                ...
                print(f"âš ï¸ Strategy error from {type(strat).__name__}: {e}")
    ...
    signal_data = {
        ...
        "price": data["close"],
        "recommended_entry_time": formatted_entry,  # âœ… time-based format
