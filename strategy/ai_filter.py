...
class SmartAIFilter:
    def __init__(
        ...
        min_support_distance=0.0002,
        min_pattern_reject_strength=0.85,  # rejeita direto se soma da força >= esse valor
        pattern_penalty_factor=15          # penalização de confiança por força dos padrões contrários
    ):
